...
Route::get('/contact-doctor', function(){
    return view('frontend.contact-doctor');
})->name('contact_doctor');
Route::get('/customer_feedback', function(){
    return view('frontend.customer_feedback');
...
Route::get('/product/id/{id}', 'HomeController@productId')->name('productId');
...
Route::group(['middleware' => ['user', 'verified', 'unbanned']], function () {
    ...
    Route::get('/purchase_buyagain', 'PurchaseHistoryController@buyagain')->name('purchase_history.buyagain');
