...
@section('content')
            ...
            <div class="row gutters-10 position-relative">
                ...
                <div class="col-lg-2 order-3 mt-3 mt-lg-0">
                    <div class="bg-white rounded shadow-sm">
                        <div class="header_color rounded-top p-3 d-flex align-items-center justify-content-center">
                            <span class="fw-600 fs-16 mr-2 text-truncate text-white">
                            ...
                            @foreach (filter_products(\App\Product::where('published', 1)->where('todays_deal', '1'))->get() as $key => $product)
                                ...
                                <div class="col mb-2">
                                    <a href="{{ route('product', $product->slug) }}" class="d-block p-2 text-reset bg-white h-100 rounded">
                                        <div class="row gutters-5 align-items-center" style="border-radius: 2px; background-color: #fafafa;">
                                            <div class="m-1">
                                                <div class="img">
                                            ...
                                            <div class="">
                                                <div class="fs-16">
                                                    <span class="d-block text-primary fw-600" style="font-size: 12px">{{ home_discounted_base_price($product->id) }}</span>
                                                    @if(home_base_price($product->id) != home_discounted_base_price($product->id))
                                                        <del class="d-block opacity-70" style="font-size: 10px">{{ home_base_price($product->id) }}</del>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
    ...
    <section class="mb-4">
        ...
        <div class="row gutters-6 row-cols-xxl-4 row-cols-xl-4 row-cols-lg-4 row-cols-md-3 row-cols-2">
            <?php $products = \App\Product::where('is_service',0)->inRandomOrder()->get(); ?>
