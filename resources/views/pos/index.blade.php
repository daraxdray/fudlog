                                        ...
                                        @if (Session::has('posCart'))
                                            @forelse (Session::get('posCart') as $key => $cartItem)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="">
                                                            <input type="hidden"  id="min_qty-{{ $key }}" value="{{ isset($cartItem['min_qty'])?$cartItem['min_qty']:0 }}">
                                                            <input type="number" class="form-control px-0 text-center"  id="qty-{{ $key }}" value="{{ $cartItem['quantity'] }}" onchange="updateQuantity({{ $key }})" min="1">
                                                        </div>
                                                    </td>
                    ...
                    <div class="pos-footer mar-btm">
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="">
                                ...
                                <a href="{{ route('all_orders.index') }}" type="button" class="btn btn-primary" >{{ translate('Print Orders Slip') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
...
@section('script')
    <script type="text/javascript">
        ...
        function updateQuantity(key){
            var qty_req = $('#qty-'+key).val();
            var min_qty = $('#min_qty-'+key).val();
        
            if(parseInt(min_qty) > parseInt(qty_req)){
                    AIZ.plugins.notify('warning',"Ensure the quantity is higher than the minimum quantity");
                    return;
                }
